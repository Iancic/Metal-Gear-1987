...
void main()
{
...
#ifdef FULLSCREEN
	window = glfwCreateWindow( SCRWIDTH, SCRHEIGHT, "metal Gear", glfwGetPrimaryMonitor(), 0 );
#else
	window = glfwCreateWindow( SCRWIDTH, SCRHEIGHT, "Metal Gear", 0, 0 );
#endif
	...
	int channelsIcon;
	unsigned char* pixels = stbi_load("assets/Others/Icon.png", &widthIcon, &heightIcon, &channelsIcon, 4);

	//change window icon
	GLFWimage images[1];
	images[0].width = widthIcon;
	images[0].height = heightIcon;
